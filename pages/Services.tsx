          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <img src="https://picsum.photos/seed/dash1/400/300" alt="Dashboard" className="rounded-2xl shadow-sm" />
                <img src="https://picsum.photos/seed/dash2/400/300" alt="Metrics" className="rounded-2xl shadow-sm" />
              </div>
            </div>
            <div>
              <span className="text-green-500 font-bold uppercase tracking-wider text-sm">Service Details</span>
              <h2 className="text-4xl font-bold mt-4 mb-8 text-gray-900">{activeService.title}</h2>
              ...
              <div className="bg-green-50 p-8 rounded-3xl border border-green-100 mb-10">
                ...
                <p className="text-gray-600 mb-6">Schedule a free strategy call with our specialists today.</p>
                <Link to="/contact" className="bg-green-500 text-white px-8 py-3 rounded-full font-bold hover:bg-green-600 transition-colors inline-block">
                  Contact Us
                </Link>
              </div>
              
              <Link to="/services" className="text-gray-500 hover:text-green-500 flex items-center font-medium">
    ...
    <div className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-green-500 font-bold tracking-widest uppercase text-sm mb-3">Expertise</h2>
